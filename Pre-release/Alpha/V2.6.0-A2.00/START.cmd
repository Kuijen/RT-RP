5REM Kills Virtual Desktop when the script starts or resets
:start
@echo off
...
if %Enable_Java_RT%==1 && %Enable_Rust_RT%==1 (
    set "Enable_Rust_RT=0" && echo .INI Conflict Found, Defaulting to Java!!
)
...
::if %Enable_Java_RT%==1 (
::    set "Enable_Rust_RT=0"
::)

if %Enable_Rust_RT%==1 (
    start "" "gnirehtet-g7.exe"
)
